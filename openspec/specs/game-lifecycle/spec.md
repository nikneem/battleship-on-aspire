...
Define the Battleship match lifecycle, including valid phase transitions, pre-game readiness and fleet setup, turn-based firing rules, caller-safe match views, and terminal outcomes.
